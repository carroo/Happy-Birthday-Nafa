  ...
  function anim() {
    ...
    if (done && benerandone == 1) {
      ...
      function askQuestion() {
        ...
        Swal.fire({
          title: 'Buat Kondirmasi. Siapa orang paling ganteng di b24?',
          input: 'text',
          ...
          if (result.isConfirmed) {
            ...
            if (answer.includes('catur') || answer.includes('tatsuro') || answer.includes('carroo')) {
